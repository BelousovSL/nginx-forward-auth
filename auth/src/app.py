...
def update_user(id, login, password, email, first_name, last_name):
    #try:
        with engine.connect() as connection:
            connection.execute(
                """
...
def update():
    if 'session_id' in request.cookies:
        ...
        if session_id in SESSIONS:
            ...
            # update data base
            update_user(data['id'], login, password, email, first_name, last_name)
